...
import static com.ksenia.pulsezonetraining.connectivity.bluetooth.BluetoothCommunicationManager.CHARACTERISTICS_HEART_RATE_MEASUREMENTS;
...
public class BluetoothUtils {
    ...
    public static final String SERVICE_STRING = convertFromInteger(HEART_RATE_SERVICE_UUID).toString();
    public static final String CHARACTERISTIC_ECHO_STRING = convertFromInteger(CHARACTERISTICS_HEART_RATE_MEASUREMENTS).toString();
    // Characteristics
